...
Searchk%2Ffibonacci-numbers"%2Ffibonacci-numbers" </a>
...
<a href="fibonacci-numbers.html#"
<a href="fibonacci-numbers.html#" class="toolbar__button toolbar__button_edit" title="open in sandbox"></a>
...
<figure><img src="fibonacci-numbers/fibonacci-recursion-tree.svg" width="640" height="225" /></figure>We can clearly notice that `fib(3)` is evaluated two times and `fib(2)` is evaluated three times. The total amount of computations grows much faster than `n`, making it enormous even for `n=77`.
