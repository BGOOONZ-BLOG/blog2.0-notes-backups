...
## <a href="async-iterators-generators.html#real-life-example-paginated-data" id="real-life-example-paginated-data" class="main__anchor">Real-life example: paginated data</a>
