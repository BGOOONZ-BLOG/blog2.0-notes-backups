...
### <a href="function-object.html#sum-with-an-arbitrary-amount-of-brackets" id="sum-with-an-arbitrary-amount-of-brackets" class="main__anchor">Sum with an arbitrary amount of brackets</a>
